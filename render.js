const render = function (posters, dropdown) {
    ...
    for (let i = 0; i < posters.length; i++) {
        // const imgDiv = $('<img>');         //ORIGINAL CODE
        // img.attr('src', posters[i].Poster) //ORIGINAL CODE
        //========================================Begin Barry's New Code
        const imgDiv = $('<div>');
        ...
        setTimeout(function(){   //added setTimeout, data sas not loading in time for render
        ...
        if (dropdown == true) {
            ...
            if (posters[i].Poster !== 'N/A' && posters[i].Type === 'movie') {
                //old code:  imgDiv.attr('src', posters[i].Poster);
